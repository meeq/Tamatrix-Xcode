...
#endif
	                           /* Compilation options:       */
//#define DEBUG_6502           /* Compile debugging version  */
...
typedef byte (*RdOp)(M6502 *cpu, register word Addr);
typedef void (*WrOp)(M6502 *cpu, register word Addr,register byte Value);
